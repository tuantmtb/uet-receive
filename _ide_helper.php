...
namespace Casperlaitw\LaravelFbMessenger\Facades {
    ...
    class MessengerMenu {
        ...
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::getMenus();
        }
        ...
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::isEmpty();
        }
         ...
         * @static 
         */
        public static function disableInput()
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::disableInput();
        }
         ...
         * @static 
         */
        public static function postback($text, $payload = '')
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::postback($text, $payload);
        }
         ...
         * @static 
         */
        public static function webUrl($args = null)
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::webUrl($args);
        }
         ...
         * @static 
         */
        public static function nested($title, $menus)
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::nested($title, $menus);
        }
         ...
         * @static 
         */
        public static function locale($locale, $menus)
        {
            return \Casperlaitw\LaravelFbMessenger\PersistentMenu\Menu::locale($locale, $menus);
        }
...
namespace {
    ...
    class Menu extends \Casperlaitw\LaravelFbMessenger\Facades\MessengerMenu {}
